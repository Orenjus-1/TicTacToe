...
def show_settings():
    ...
    while settings_running:
        ...
        draw_button_with_text("Back to Menu", (SCREEN_WIDTH//2 - 100, SCREEN_HEIGHT//2 + 20))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pygame.Rect(SCREEN_WIDTH//2 - 100, SCREEN_HEIGHT//2 - 50, 200, 50).collidepoint(mouse_pos):
                    click_sound.play()
                    # Change theme or other settings logic
                elif pygame.Rect(SCREEN_WIDTH//2 - 100, SCREEN_HEIGHT//2 + 20, 200, 50).collidepoint(mouse_pos):
                    click_sound.play()
...
def game_loop():
    ...
    if check_best_of_3():
        ...
        if winner == player_choice:
            pygame.time.wait(2000)  # Wait before returning to menu if player wins
        else:
            pygame.time.wait(2000)
        show_menu()
    else:
